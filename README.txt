...
a persistence unit "gestioneitorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "gestioneitor/pom.xml":
...
artifact ("gestioneitor.war") is already built. You can build
